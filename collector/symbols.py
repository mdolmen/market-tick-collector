...
OVERLAPPING_BASES: Final[tuple[str, ...]] = (
    "1INCH", "2Z", "AAVE", "ACH", "ADA", "AERO", "AI", "ALGO", "ALICE",
    "ALLO", "ALT", "ANKR", "APE", "API3", "APT", "ARB", "ARKM", "ARPA",
    "ASTER", "ATOM", "AUCTION", "AUDIO", "AVAX", "AVNT", "AXS", "BAND",
    "BAT", "BCH", "BERA", "BICO", "BIGTIME", "BIO", "BLUR", "BNB", "BNT",
    "BONK", "BREV", "BTC", "C98", "CAKE", "CELR", "CFG", "CHIP", "CHZ",
    "COMP", "COOKIE", "COTI", "COW", "CRV", "CTSI", "CVC", "CVX", "DASH",
    "DOGE", "DOLO", "DOT", "EGLD", "EIGEN", "ENA", "ENS", "ESP", "ETC",
    "ETH", "ETHFI", "EUL", "FET", "FIDA", "FIL", "FLOKI", "FLOW", "G",
    "GMT", "GNO", "GRT", "GTC", "HBAR", "ICP", "IMX", "INJ", "JASMY", "JTO",
    "KAITO", "KAT", "KAVA", "KERNEL", "KMNO", "KNC", "KSM", "LAYER", "LDO",
    "LINEA", "LINK", "LPT", "LQTY", "LTC", "MANA", "MASK", "ME", "MEGA",
    "MET", "METIS", "MINA", "MORPHO", "NEAR", "NMR", "OGN", "ONDO", "OP",
    "OPN", "ORCA", "OSMO", "PAXG", "PENDLE", "PENGU", "PEPE", "PLUME",
    "PNUT", "POL", "POWR", "PROVE", "PUMP", "PYTH", "QI", "QNT", "RAD",
    "RARE", "RAY", "RE", "RED", "RENDER", "REQ", "REZ", "RLC", "ROBO",
    "RPL", "RSR", "S", "SAND", "SAPIEN", "SEI", "SENT", "SHIB", "SIGN",
    "SKY", "SNX", "SOL", "SPELL", "SPK", "STG", "STRK", "STX", "SUI",
    "SUPER", "SUSHI", "SXT", "SYRUP", "T", "TAO", "TIA", "TNSR", "TREE",
    "TRUMP", "TURBO", "UMA", "UNI", "USD1", "USDS", "VET", "VIRTUAL",
    "VTHO", "W", "WAL", "WCT", "WIF", "WLD", "WLFI", "XLM", "XPL", "XRP",
    "XTZ", "YB", "YFI", "ZAMA", "ZEC", "ZK", "ZKP", "ZRO", "ZRX",
)
